...
typeof ctx (Men e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                       (Just TNum, Just TNum)   -> Just TBool 
                       _                        -> Nothing

typeof ctx (Mai e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                       (Just TNum, Just TNum)   -> Just TBool 
                       _                        -> Nothing

typeof ctx (MenEq e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                       (Just TNum, Just TNum)   -> Just TBool 
                       _                        -> Nothing

typeof ctx (MaiEq e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                       (Just TNum, Just TNum)   -> Just TBool 
                       _                        -> Nothing
...
typeof ctx (Ternario v e1 e2) = case typeof ctx v of
                                Just TBool -> Just TBool
                                _          -> Nothing
